    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          >
            {loading ? "Transcribing & Analyzing... (may take a moment)" : "Analyze Audio"}
          </button>
        </div>
        ...
        {result && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            {renderList("Scam Keywords Found", result.scam_keywords_found)}
            {renderList("Money Request Keywords", result.money_request_keywords)}
            {renderList("OTP Request Keywords", result.otp_keywords)}
            {renderList("Emotional Manipulation Phrases", result.manipulation_keywords)}
          </div>
        )}
      </div>
    </div>
